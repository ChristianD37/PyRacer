...
class Map():
    ...
    def draw_stats(self):
        ...
        if self.car.speed > .9:
            speed_color = (255,0,0)
        self.game.draw_text('Speed (Km): ' + str(round(self.car.speed * 100,2)) , 20, speed_color, 10,10)
        self.game.draw_text('Time: ' + str(round(self.game.lap_time, 2)), 20, (255, 255, 255), 10, 30)
        self.game.draw_text('Lap: ' + str(self.lap) + "/2", 20, (255, 255, 255), 10, 50)
        if self.game.complete: self.game.draw_text('FINISHED', 20, (255, 255, 255), self.mid_w - 10,self.mid_h)

        i = 0
        for lap in self.lap_times:
            self.game.draw_text('Lap ' + str(i+ 1) +': ' + str(round(lap,2)), 20, (255, 255, 255) ,
                                self.game.DISPLAY_W - 100, 10 + (20 * i))
            i += 1
